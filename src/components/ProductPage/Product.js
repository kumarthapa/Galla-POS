                  ...
                  {multirows ?
                    <>
                      {data.map((two_rows_data, index) => (
                        <Card className={classes.card} key={two_rows_data.id}>
                          <CardActionArea onClick={() => { AddToCart(two_rows_data) }} className={classes.CardActionArea}>
                            <Grid container direction="row" justify="center" alignItems="center">
                              <Grid item>
                                <Box p={1}><p>erru</p>
                                  {two_rows_data.item_image ?
                                    <CardMedia
                                      className={classes.media}
                                      image={two_rows_data.item_image}
                                      title={two_rows_data.name}
                                    />
                                    :
                                    <CardMedia
                                      className={classes.media}
